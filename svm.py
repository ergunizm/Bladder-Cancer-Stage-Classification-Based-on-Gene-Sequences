...
cm = confusion_matrix(y_test, y_pred, labels=svmCls.classes_)
disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=svmCls.classes_)
disp.plot()
plt.show()